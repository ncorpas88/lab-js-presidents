...
function getNames(presidentsArr) {
  let arrPresidentOnly = presidentsArr.map((eachPresident, index) => {
    return eachPresident.name;
  })
  return arrPresidentOnly;
}
...
function getDemocraticPresidents(presidentsArr) {
  let filterPresident = presidentsArr.filter((eachPresident) => {
    if(eachPresident.party === "Democratic"){
      return true;
    }
  })
...
function  countYearsInOffice(presidentsArr) {
  let totalYears = presidentsArr.reduce((acc, president) => {
...
function getAgeAtInauguration(presidentsArr) {
  let newArr = presidentsArr.map((eachPresident, index) => {
    let newProperty = eachPresident.getAgeAtInauguration
  })
}
